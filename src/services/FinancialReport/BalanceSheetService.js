// src/services/FinancialReport/BalanceSheetService.js
import { db } from "@/lib/firebase";
import { collection, getDocs } from "firebase/firestore";

export const fetchBalanceSheetRawData = async () => {
  try {
    ...
    console.error("Error fetching Balance Sheet raw data:", error);
    throw error;
  }
};